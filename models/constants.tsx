 ...
 */
export const API_URL = window.location.href.includes("testing") ? "https://reminderse-testing.herokuapp.com" : process.env.NODE_ENV === "development" ? "http://localhost:5000" : "https://api.reminderse.com";
