...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="p-2 lg:p-10 homepage-main">
          <div className="flex justify-center align-items-center pt-5 z-10">
            <nav className="flex justify-between w-full max-w-screen-2xl">
              ...
              <ul className="flex align-items-center text-right">
                <li className="mr-2">
          ...
          <div className="blob hidden md:block">
            <svg
              viewBox="0 0 500 500"
          ...
          <div className="main-text">
            <h1 className="text-4xl text-center font-bold lg:text-7xl">
      ...
      <footer className="footer bg-primary text-base-content footer-center lg:p-10 p-2">
        <div>
